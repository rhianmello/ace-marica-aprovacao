...
(function(){
  ...
  (async()=>{
    try{
      ...
      if(deviceError||deviceAllowed!==true){blocked('Sua conta já possui 2 dispositivos ativos. Para entrar neste dispositivo, revogue um dos dispositivos atuais no painel administrativo.');return;}
